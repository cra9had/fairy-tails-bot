...
Напиши содержание первого сезона в виде плана серий.  Указывая только названия эпизода, серий и содержащийся в ней урок. Начни без вступления и комментариев сразу с содержания. Не используй знаков # и *. В конце дай краткую аннотацию к этому сезону, где также опиши развивающий эффект.
"""

SEASON_PLAN_CONTINUE = "Напиши содержание второго сезона."

SEASON_PLAN_PICTURE = "Нарисуй картинку к сезону сказки по её краткому плану: \n {tale_plan}"
...
Удостоверься, что текст адаптирован под возраст ребенка и его словарный запас. Не используй прямую речь и знаки # и *. Начни с названия серии.
